# # tile_geoparquet/hist_pyramid.py
...
# # ---------------------------------------------------------------------------
# # PER-TILE HISTOGRAM ACCUMULATOR
# # ---------------------------------------------------------------------------
...
#         futures = [
#             ex.submit(
#                 lambda rg: _accumulate_vertices_hist(
...
#     # Determine grid shape from first tile
...
#         "crs": "EPSG:3857",
#         "bbox": list(GLOBAL_BBOX),
#         "desc": "2D prefix-sum histogram (summed-area table)."
#     }
#     with open(outdir / "global_prefix.json", "w") as f:
#         json.dump(prefix_json, f, indent=2)

#     # ---------------- Delete Intermediate Tile Histograms ----------------
#     for f in tile_files:
...
#     # Build global histogram + prefix sum
